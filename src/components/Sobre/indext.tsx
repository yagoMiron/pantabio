          ...
          <div className={styles.info}>
            <div>
              ...
              <p className={styles.text}>
                ...
                biológicas e sustentáveis para a agricultura. Trabalhamos com
                fungos especiais chamados Trichoderma, nativos do Pantanal e no
                Cerrado brasileiro!
              </p>
            </div>
            <div>
              ...
              <p className={styles.text}>
                ...
                permitindo que produtores rurais de qualquer tamanho possam
                cultivar de forma saudável, eficiente e sem prejudicar a
                natureza.
              </p>
            </div>
            <div>
